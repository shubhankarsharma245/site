...
swal({
	...
	if(value===true) {
		swal({
			...
			if(value===true) { 
				window.open('https://drive.google.com/file/d/1zd1ingzNg_tgNJVjKx2FANY_4X4H-9ge/view?usp=drive_link');
			}
		})
	}
});
...
function loadShubhSays() {
	const shubhSaysInnerHtml = `<div class="col m6">
	...
	$('#shubhSays').html(shubhSaysInnerHtml);
}
